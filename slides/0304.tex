...
\end{align*}\noindent
means ``for all worlds $w'$ such that $w' \models x : \urt{\Int}{0 \leq \vnu \leq 2}$, we have $w \sim w'$''.

\textbf{Compare with Necessity modality:}
\begin{align*}
    w \models x : \square\ort{\Int}{0 \leq \vnu \leq 2}
\end{align*}\noindent
means ``for all worlds $w'$ such that $w \sim w'$, we have $w' \models x : \urt{\Int}{0 \leq \vnu \leq 2}$''.
