...
\begin{frame}[fragile]
    \frametitle{Strategy Algebra: Commutative Semiring}
...
\begin{frame}[fragile]
    \frametitle{Strategy Algebra: Examples}
...
\begin{frame}[fragile]
    \frametitle{Strategy Logic}

\begin{definition}[Strategy Logic] A strategy logic is an intuitive logic with $*$, $\wand$, and $\oplus$ operators.
\end{definition}
\begin{itemize}
...
\begin{frame}[fragile]
    \frametitle{Strategy Logic: Monotonicity}
...
\begin{frame}[fragile]
    \frametitle{Strategy Logic: Examples}
...
\begin{frame}[fragile]
    \frametitle{Strategy Logic: compare with previous version}
...
\begin{frame}[fragile]
    \frametitle{Strategy Logic: Persistency}
...
\begin{frame}[fragile]
    \frametitle{Strategy Logic: Other modalities}
