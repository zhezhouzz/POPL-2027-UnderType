...
\textbf{Compact Representation:} We directly use a set of worlds $W$ (they share the same domain) to represent a model, that is the basic model with domain $\Code{Dom}{W}$ plus the entanglement relation $\sim$ generated from the rules above.
\end{frame}
