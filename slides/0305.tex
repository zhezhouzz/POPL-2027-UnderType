...
\begin{definition}[Well-formedness]
    ...
    \begin{itemize}
        \item (1) $\forall \sigma_1\;\sigma_2 \in \Sigma^+.\Code{Dom}(\sigma_1) = \Code{Dom}(\sigma_2)$.
        \item (2) $\forall \sigma\in \Sigma^+.\forall \sigma'\in \Sigma^-. \sigma' \subseteq \sigma \impl \sigma' \notin \Sigma^-$.
        \item (3) $\forall \sigma. \Code{Dom}(\sigma) = \Code{Dom}(\Sigma^+) \implies \sigma \in \Sigma^+ \lor \sigma \in \Sigma^-$.
    \end{itemize}
\end{definition}
...
\begin{align*}
    O(\Sigma^+) \doteq \{ \sigma ~|~ \Code{Dom}(\sigma) = \Code{Dom}(\Sigma^+) \land \forall x. \exists \sigma' \in \Sigma^+. \sigma(x) = \sigma'(x) \}
\end{align*}\noindent
...
\begin{definition}[Composition]
    ...
    \end{align*}\noindent
    $\compable{m_1}{m_2}$ iff $\wfvdash m_1 \circ m_2$ and $\Code{Dom}(m_1.\Sigma^+) \cap \Code{Dom}(m_2.\Sigma^+) = \emptyset$.
\end{definition}
...
\begin{definition}[Bunched Implication Semantics]
    ...
    \\(\Sigma^+, \Sigma^-) \models \boxtimes_5 \phi &\text{ iff } \{\sigma ~|~ (\sigma, \Sigma^-) \models \phi \land \Code{Dom}(\sigma) = \Code{FV}(\phi) \} \sqsubseteq \Sigma^+
    \end{align*}\noindent
\end{definition}
