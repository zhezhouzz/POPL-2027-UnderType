...
\end{prooftree}
    ...
    \begin{prooftree}
      ...
      \infer1[\textsc{\small StGen}]{
        \steptr{\alpha}{(\buf', \zgen{op}{\overline{v}}{e})}{[\zevent{op}{\overline{v}}]}{(\buf \listconcat \buf', e)}
      }
    \end{prooftree}
    \\ \ \\ \ \\    
    \begin{prooftree}
...
\\ \
\mprooftr{55mm}
{$\Gamma \vdashA{A} \atriple{t_x}{B_x}{A_x} \termsyn (e_x, B)$ \quad
 $\Gamma, x{:}{t_x} \vdashA{A \seqA A_x} \atriple{t}{B'}{A'} \termsyn (e, B_x)$}
{TConcat}
{$\Gamma \vdashA{A} \atriple{t}{B'}{A_x; A'} \termsyn (\zlet{x}{e_x}{e}, B)$}
\quad
\mprooftr{50mm}
{$\Gamma \vdashA{A} \atriple{t}{B'}{A_1'} \termsyn (e_1, B_1)$ \quad
$\Gamma \vdashA{A} \atriple{t}{B'}{A_2'} \termsyn (e_2, B_2)$}
{TUnion}
{$\Gamma \vdashA{A} \atriple{t}{B'}{A_1' \lor  A_2'} \termsyn (e_1 \oplus e_2, B_1 \land B_2)$}
\\ \ \\ \ \\
\mprooftr{32mm}
{$\Gamma \vdashA{A} \atriple{t}{B'}{\epsilon} \termsyn (e, B)$}
{TStar1}
{$\Gamma \vdashA{A} \atriple{t}{B'}{A^*} \termsyn (e, B)$}
\quad
\mprooftr{35mm}
{$\Gamma \vdashA{A} \atriple{t}{B'}{A \seqA A^*} \termsyn (e, B)$}
{TStar2}
{$\Gamma \vdashA{A} \atriple{t}{B'}{A^*} \termsyn (e, B)$}
\quad
\mprooftr{33mm}
...
\mprooftr{70mm}
{
$\Gamma \vdash \eff{op} : \hfour{A}{B}{\msgB{op}{\overline{x}}{\phi}}{B_x}$ \quad
 $\Gamma \vdashA{A\seqA\msgB{op}{\overline{y}}{\bigwedge\overline{y=v}}} \atriple{t}{B'}{A'} \termsyn (e, B \seqA B_x)$}
{TGen}
{$\Gamma \vdashA{A} \atriple{t}{B'}{\msgB{op}{\overline{x}}{\phi} \seqA A'} \termsyn (\zgen{op}{\overline{v}}{e}, B)$}
\\ \ \\ \ \\ 
\mprooftr{105mm}
{
$\Gamma \vdash \eff{op} : \hfour{A}{B_1}{\msgB{op}{\overline{x}}{\phi}}{B_3}$ \quad
$\Gamma,  \overline{x{:}t}\vdash \nuot{unit}{\top} <: \nuot{unit}{\phi}$ \quad
 $\Gamma, \overline{x{:}t} \vdashA{A \seqA \msgB{op}{\overline{x}}{\phi}} \atriple{t}{B'}{A'} \termsyn (e, B_1 \seqA B_2 \seqA B_3)$}
{TObs}
{$\Gamma \vdashA{A} \atriple{t}{B'}{\msgB{op}{\overline{x}}{\phi} \seqA A'} \termsyn (\zobs{\overline{x}}{op}{e}, B_1 \seqA \msgB{op}{\overline{x}}{\phi} \seqA B_2)$}
\\ \ 
{\small
\begin{flalign*}
