...
work~\cite{RefinementTypeRefutations, CoverageType, Ill-types} that
...
arbitrary function supplied for $f$ will satisfy the reachability
...
and captured variables when both are treated angelically.
...
{ \setlength{\jot}{-2pt} % Tighten line space for just this example
\begin{align*}
...
nondeterminism, along with supporting modifications to the logic and
denotational semantics.  Section~\ref{sec:case} presents several case
studies for which context types are particularly well-aligned.  A
