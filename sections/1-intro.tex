...
a goal of avoiding the high false positive rate reported
by typical bug detection tools.  The question of how to develop type
systems for reachability properties, however, has been largely
unexplored.  Recent work~\cite{RefinementTypeRefutations,
...
generators~\cite{CoverageType}, or application, e.g., generating
