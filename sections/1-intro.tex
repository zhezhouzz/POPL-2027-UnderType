...
the constraints defined by $\tau$. Conversely, when establishing the
typing judgment $x{:} \urt{b}{\phi} \vdash e : \tau$, $x$ is treated
\emph{angelically}, since we can safely assume that $x$ can take on
every value consistent with $\phi$ (and maybe more).
...
context independence analogously to the way bunched
