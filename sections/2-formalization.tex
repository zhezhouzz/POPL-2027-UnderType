...
% {$\Gamma \ctvdashs \tau_1 <: \tau_2$}
  ...
  % \quad
  % \mprooftr{60mm}
  % {$\Gamma \ctcomma x{:}(\ctind \tau_x) \ctvdash e : \tau$ \quad $\Dom{\Gamma}\cap \Dom{\tau_x} = \emptyset$ }
  % {Trans$_{\ctind}$}
  % {$\Gamma \ctstar x{:}(\ctind \tau_x) \ctvdash e : \tau$}
  % \quad
  % \mprooftr{30mm}
...
\begin{figure}[h]
  ...
  \quad
  \mprooftr{32mm}
  {$\Delta \ctvdash e_1 : \tau_1 $ \quad $\Delta, (\Gamma \ctstar x{:}\tau_1) \ctvdash e_2 : \tau_2$}
  {T-LetD}
  ...
  \quad
  \mprooftr{46mm}
  {$\Gamma \ctvdash v_1 : x{:}\tau_x \ctwand \tau_y$ \quad 
  $\Delta \ctvdash v_2 : \tau_x$ \quad 
  $\Delta, (\Gamma \ctstar y{:}\tau_y) \ctvdash e : \tau$ }
  {T-AppFunD}
  {$\Delta, \Gamma \ctvdash \zlet{y}{v_1\;v_2}{e} : \tau$}
  \\[.8em]
  \mprooftr{40mm}
  ...
  \quad
  \mprooftr{50mm}
  {$\Gamma \ctvdash \primop : \overline{x_i{:}\tau_i}\ctwand \tau_y$ \quad 
    $\forall i. \Delta \ctvdash v_i : \tau_i$ \quad 
  $\Delta, (\Gamma \ctstar \overline{x_i{:}\tau_i}) \ctvdash e : \tau$ }
  {T-AppOpD}
  {$\Delta, \Gamma \ctvdash \zlet{y}{\primop\;\overline{v_i}}{e} : \tau$}
  \\[.8em]
  \mprooftr{64mm}
