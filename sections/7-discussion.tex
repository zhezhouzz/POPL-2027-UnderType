...
automated inference techniques, e.g., bi-abduction, which enables
scalable inference of preconditions and frame information and
underpins modern automated separation-logic analyzers. Prior
refinement type systems~\cite{CoverageType} have also shown that
placing restrictions on, e.g., where angelic and demonic modalities
can appear, can ensure that verification conditions remain decidable.
Developing analogous inference techniques and restrictions to enable
an automated verification procedure based on our context type system
is an interesting direction for future work.

\BD{Do we want to add a blurb about developing a VST / Iris-style
  interactive verification framework as an alternative direction?}
