...
%       respect to its specification.
  ...
  Existing approaches, however, typically fix on one style of reasoning
      ...
      argument $x$ and $y$ as a integer greater than $0$ and asserts that the result is an integer greater equal to $0$ but less equal to $x$:
      \[x : \{\Code{int}\, |\ 0 \leq \nu\}, y : \Code{\{\Code{int}\, |\, 0 \leq \nu \}}
      \vdash x\;\Code{-}_{\Code{nat}}\;y : \{\Code{int}\, |\, 0 \leq \nu
      \leq x \}\] 
      The standard implementation is $\Code{-}_{\Code{nat}} \doteq \lambda x.\lambda y. \zif{x \leq y}{x - y}{0}$.
