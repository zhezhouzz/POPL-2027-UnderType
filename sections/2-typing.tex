...
call-by-value lambda calculus with pattern-matching (conditional expression is a syntax sugar of pattern matching), inductive
datatypes, and recursive functions.  Expressions are written in
monadic normal form (MNF)~\cite{JO94}, a variant of A-Normal Form
(ANF)~\cite{FSDF93} that allows nested let-bindings. 
We also equip the
...
\end{align*}\noindent
Here, we consider two concrete (reified) environments, $\EnvirDep$ and
