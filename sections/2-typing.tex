...
\paragraph{Dependent and Disjoint Contexts} As discussed in
Section~\ref{sec:intro}, type contexts can be related via dependent or
disjoint conjunction, as illustrated below:
\begin{align*}
