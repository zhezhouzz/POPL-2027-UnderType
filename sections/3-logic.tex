...
subset of the environments in $r$. We would like to highlight that the refinement relation $\sqsubseteq$ can also used to extends the entailment of demonic and angelic modalities. Consider the following example:
\begin{align*}
\begin{array}{c @{\hspace{1.5em}} c @{\hspace{1.5em}} c}
  {\{[x \mapsto 1], [x \mapsto 2]\}} & \sqsubseteq & {r' \doteq \{[x \mapsto 1; y \mapsto 2], [x \mapsto 2; y \mapsto 7]\}} \\[0.6em]
  \vsubseteq & & \vsubseteq \\[0.6em]
  {r \doteq \{[x \mapsto 1]\}} & \sqsubseteq & {\{[x \mapsto 1; y \mapsto 2]\}}
\end{array}
\end{align*}\noindent
For some angelic formula $\angelic P$, if we have $r \models \angelic P$, then we also have $r' \models \angelic P$. We have simluar result for demonic formula $\demonic P$ (i.e., $r \models \demonic P$ implies $r' \models \demonic P$) with in the following example:
\begin{align*}
\begin{array}{c @{\hspace{1.5em}} c @{\hspace{1.5em}} c}
  {\{[x \mapsto 1]\}} & \sqsubseteq & {r' \doteq \{[x \mapsto 1; y \mapsto 2]\}} \\[0.6em]
  \vsupseteq & & \vsupseteq \\[0.6em]
  {r \doteq \{[x \mapsto 1], [x \mapsto 2]\}} & \sqsubseteq & {\{[x \mapsto 1; y \mapsto 2], [x \mapsto 2; y \mapsto 7]\}}
\end{array}
\end{align*}\noindent
