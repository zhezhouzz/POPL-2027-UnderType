...
and $\sigma_2 \in
r_2$; it combines capabilities over disjoint variable domains. \ZZ{the varaible domain is allowed to be not disjointed, which is important for resource duplication which will be used in sec 4 and 5. }
The
...
$r$ if some lower bound $r' \sqsubseteq r$ satisfies $P$;
