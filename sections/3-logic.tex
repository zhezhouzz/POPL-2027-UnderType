...
\[
  r \models \denot{\Code{Total}(e) \land \eraserf{\Gamma}\basicvdash e : \eraserf{\tau} } \;\iff\;
...
\begin{align*}
  ...
  \\\denot{\ort{b}{\phi}}\;e &\doteq \denot{e}_\vnu \chimpl \forallM{\Code{FV}(\ort{b}{\phi})}\,\subExt \phi \quad \text{($\vnu$ is a fresh variable)}
  \\\denot{\urt{b}{\phi}}\;e &\doteq \denot{e}_\vnu \chimpl \forallM{\Code{FV}(\urt{b}{\phi})}\,\supExt \phi \quad \text{($\vnu$ is a fresh variable)}
  \\\denot{x{:}\tau_x \ctsarr \tau}\; e &\doteq \denot{\tau_x}\;x \chimpl \denot{\tau}\;(e\;x) \quad \text{($x$ is a fresh variable)}
  \\\denot{x{:}\tau_x \ctwand \tau}\; x &\doteq \denot{\tau_x}\;x \chwand \denot{\tau}\;(e\;x) \quad \text{($x$ is a fresh variable)}
