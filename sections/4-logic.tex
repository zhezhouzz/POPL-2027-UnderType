...
We now define a logic over the capability algebra.  The logic is a BI
...
Critically, entailment of demonic and angelic modalities is also
...
the context logic described above, and state the main soundness
