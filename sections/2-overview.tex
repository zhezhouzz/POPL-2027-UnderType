...
into these contexts can all reach every possible positive
number, as can the program \ref{ex:DisjCon}[$x - y$].  The same cannot
be said of \ref{ex:EnCon}[$x - y$], however, because the values of
...
\emph{entangled} conjunction, $\ctcomma$, meaning we are free to choose a value for one
