...
environments, or \emph{capability}, that are constrained by a typing
context.
...
for $x$, the values for $y$ provided by a capability are now limited,
and $y$ can no longer be chosen independently. Concretely, the angelic
...
assumptions about a \emph{subset} of the environments that term may be
run in. It is possible, however, to derive meaningful safety
