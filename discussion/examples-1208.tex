    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \begin{align*}
                ...
                & \eff{ref}: x{:}\tvar{a} \sarr M_{\Code{ref}}\evparenth{\qt{\vnu{:}\Code{Map.t}}{\top}, \qt{r{:}\tvar{a}\;\Code{ref},m{:}\Code{Map.t},\vnu{:}\Code{Map.t}}{r \not\in \Code{Dom}(m) \land \vnu = m \cup (r, x)}} \;\urt{\tvar{a}\;\Code{ref}}{\top} \\
                & \eff{deref}: l{:}\tvar{a}\;\Code{ref} \sarr M_{\Code{ref}}\evparenth{\qt{\vnu{:}\Code{Map.t}}{l \in \Code{Dom}(\vnu)}, \qt{r{:}\tvar{a},m{:}\Code{Map.t},\vnu{:}\Code{Map.t}}{r = m[l] \land \vnu = m}} \;\urt{\tvar{a}}{\top} \\
                & \eff{updateRef}: l{:}\tvar{a}\;\Code{ref} \sarr y{:}\tvar{a} \sarr M_{\Code{ref}}\evparenth{\qt{\vnu{:}\Code{Map.t}}{l \in \Code{Dom}(\vnu)}, \qt{\_,m{:}\Code{Map.t},\vnu{:}\Code{Map.t}}{\vnu = m[l \mapsto y]}} \;\Unit
            \end{align*}
